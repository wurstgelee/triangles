...
static const int64 MAX_MONEY = 120000 * COIN;
...
public:
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // triangles: get transaction coin age
...
public:
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // triangles: calculate total coin age spent in block
