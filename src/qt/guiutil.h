...
/** Utility functions used by the Triangles Qt UI.
 */
namespace GUIUtil
{
    ...
    // Render TRI addresses in monospace font
    ...
    // See Triangles URI definition discussion here: https://bitcointalk.org/index.php?topic=33490.0
    ...
    */
    ...
    /** Help message for Triangles-Qt, shown with --help. */
