    ...
    rpcConsole(0)
{
    ...
    setObjectName("trianglesApp");
    //setStyleSheet("#trianglesApp { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:1, stop:0 #757575, stop:1.0 #979797); } QToolTip { color: #121212; background-color: #545454;  border:0px;} ");
    setStyleSheet("#trianglesApp { background-color: #B2B2B2; } QToolTip { color: #121212; background-color: #545454;  border:0px;} ");
    ...
    labelMintingIcon->setStyleSheet("#labelMintingIcon QToolTip {color:#121212;background-color:#545454;border:0px;}");
    ...
    statusBar()->setStyleSheet("#trianglesStatusBar { border-top-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #303030, stop:0.5 #696969, stop:1.0 #696969); border-top-width: 1px; border-top-style: inset; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #757575, stop:1.0 #979797); color: #b2b2b2; } QToolTip { color: #121212; background-color: #545454; border:0px;}");
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { min-height:36px;color:#b2b2b2;border:none;margin:0px;padding:0px;} QToolButton:hover { color: #A84408; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #757575, stop:1.0 #979797); margin:0px; padding:0px; border:none; } QToolButton:checked { color: #A84408; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #757575, stop:1.0 #979797); margin:0px; padding:0px; border-right-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #3b3b3b, stop:0.5 #6c6c6f, stop:1.0 #6c6c6f);border-right-width:3px;border-right-style:inset; border-left-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #2a2a2a, stop:0.5 #5f5b5b, stop:1.0 #5b5b5e);border-left-width:2px;border-left-style:inset; } QToolButton:pressed { color: #A84408; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #757575, stop:1.0 #979797); margin:0px; padding:0px; border:none;} QToolButton:selected { color: #ffffff; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #474748, stop:1.0 #353536); margin:0px;padding:0px;border:none; } #tabsToolbar { min-height:48px; color: #b2b2b2; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #745445, stop:1.0 #757575); margin:0px; padding:0px; border-top-color: rgba(160, 160, 160, 191); border-top-width: 1px; border-top-style: inset; } QToolBar::handle { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #745445, stop:1.0 #757575); }");
    toolbar2->setStyleSheet("QToolButton { min-height:36px;color:#b2b2b2;border:none;margin:0px;padding:0px;} QToolButton:hover { color: #A84408; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #757575, stop:1.0 #979797); margin:0px; padding:0px; border:none; } QToolButton:checked { color: #A84408; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #757575, stop:1.0 #979797); margin:0px; padding:0px; border-right-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #3b3b3b, stop:0.5 #6c6c6f, stop:1.0 #6c6c6f);border-right-width:3px;border-right-style:inset; border-left-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 #2a2a2a, stop:0.5 #5f5b5b, stop:1.0 #5b5b5e);border-left-width:2px;border-left-style:inset; } QToolButton:pressed { color: #A84408; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #757575, stop:1.0 #979797); margin:0px; padding:0px; border:none;} QToolButton:selected { color: #ffffff; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #474748, stop:1.0 #353536); margin:0px;padding:0px;border:none; } #actionsToolbar { min-height:48px; color: #b2b2b2; background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #745445, stop:1.0 #757575); margin:0px; padding:0px; border-top-color: rgba(160, 160, 160, 191); border-top-width: 1px; border-top-style: inset; } QToolBar::handle { background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:0, y2:1, stop:0 #745445, stop:1.0 #757575); }");
}
