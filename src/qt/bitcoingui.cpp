    ...
    rpcConsole(0)
{
    ...
    setStyleSheet("#trianglesApp { background-color: qlineargradient(spread:pad, x1:0.2, y1:0, x2:0.9, y2:1, stop:0 #A8A7A7, stop:0.4 #DFD5D5, stop:0.5 #E1D5D5, stop:0.6 #DFD5D5, stop:1 #A8A7A7); } QToolTip { color: #121212; background-color: #858484;  border:0px; border-radius:10px} ");
